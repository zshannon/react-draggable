...
export default class DraggableCore extends React.Component<DraggableCoreProps, DraggableCoreState> {
  ...
  elForTouchStart: ReactElement<any>;
  ...
  handleRef: ReactElement<any> = (elForTouchStart) => {
    if (this.elForTouchStart) removeEvent(this.elForTouchStart, eventsFor.touch.start, this.onTouchStart);
    this.elForTouchStart = elForTouchStart;
    addEvent(this.elForTouchStart, eventsFor.touch.start, this.onTouchStart);
  }
